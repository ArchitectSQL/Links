...
namespace Web4pro\LoginAsCustomer\Model;
...
class Login extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'web4pro_login_as_customer';
    ...
    {
        $this->_init('Web4pro\LoginAsCustomer\Model\ResourceModel\Login');
    }
    ...
    public function deleteNotUsed()
    {
        ...
        $resource->getConnection()->delete(
            $resource->getTable('web4pro_login_as_customer'),
            [
    ...
    public function authenticateCustomer()
    {
        if ($this->_customerSession->getId()) {
            /* Если Customer онлайн , а я пытаюсь зайти  */
