...
define([
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'Web4pro_Address/billing-address'
            },
            ...
            updateAddress: function () {
                ...
                if (this.selectedAddress() && this.selectedAddress() != newAddressOption) { //eslint-disable-line eqeqeq
                    ...
                    if (!this.source.get('params.invalid')) {
                        ...
                        //addressData['type'] = this.source.billingAddress.custom_attributes.type;
                        ...
                        newBillingAddress['type'] = this.source.billingAddress.custom_attributes.type;
