    ...
    map: {
        '*': {
            ...
            "Magento_Checkout/js/view/shipping-information/address-renderer/default":
                "Web4pro_Address/js/view/shipping-information/address-renderer/default-override",
            "Magento_Checkout/js/view/billing-address":
                "Web4pro_Address/js/view/billing-address-override"
        }
    },
    config: {
        mixins: {
            ...
            'Magento_Checkout/js/action/place-order': {
                'Web4pro_Address/js/action/place-order-mixin': true
            }
        }
    }
};